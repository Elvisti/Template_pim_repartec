...
import br.unip.ads.pim.model.Pessoa;
...
public class AuthProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication auth) throws AuthenticationException {
        ...
        //Pessoa pessoa = clienteRepository.findByCpfAndSenha(login, senha);
        //if (pessoa != null) {
		//	return new UsernamePasswordAuthenticationToken(login, senha, emptyList());
        //}        
        Pessoa pessoa = funcionarioRepository.findByCpfAndSenha(login, senha);
        if (pessoa != null) {
			return new UsernamePasswordAuthenticationToken(login, senha, emptyList());
        }
